...
int main(int argc, char *argv[]){
  ...
  double vis[Nbody + PADDING] __attribute__((aligned(64)));
  double radius[Nbody + PADDING] __attribute__((aligned(64)));
  double mass[Nbody + PADDING] __attribute__((aligned(64)));
